  ...
  render() {
    return <div>
      <form>
        ...
        <input type="text" id="input_db" name="ininput_dbput_nev" placeholder="Mennyiség..." /><br />             
        <input type="button" id="btn_submit" name="btn_submit" value="Hozzáadás a kosárhoz" /><br />
      </form>
      <hr />
